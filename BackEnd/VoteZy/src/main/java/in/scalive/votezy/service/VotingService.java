...
public class VotingService {
	...
	public Vote castVote(Long voterId, Long candidateId) {
		...
		if (voter.isHasVoted()) {
			throw new VoteNotAllowedException("Voter Id: " + voterId + " Already caseted vote");
